            ...
            <React.Fragment>
                ...
                <main className={classes.layout}>
                    <Paper className={classes.paper}>
                        ...
                        <Typography variant='h6'>Deletion cannot be undone!</Typography>
...
export default compose(
    withFirebase,
    withStyles(styles),
    withRouter, firestoreConnect((props: UserDeletePageProps) => {
    ...
    connect(
        ({firestore: {data}}: any, props: UserDeletePageProps) => {
            const userId = props.match.params[routes.URL_PARAM_USER];
            return {
                user: data.users
                    && data.users[userId]
